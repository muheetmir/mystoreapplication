...
public class TestScript extends TestSuiteBase{
	private ReportLogService report = new ReportLogServiceImpl(TestScript.class);
	...
	public void sampleTest(String os, String osVersion, String br, String browserVersion) {
		...
		browser.getClick().clickButtonByName(LocatorType.XPATH, "//div[@class='FPdoLc tfB0Bf']//input[@name='btnK']");
